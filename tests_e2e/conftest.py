...
index.html via file:// - survey.js's fetch("generated/data.json") and
analysis.js's fetch("generated/analysis_<round>.json") calls require http,
same reason the repo doesn't support file:// today.
